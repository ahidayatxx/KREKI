...
For a deep dive into the architecture and real-world applications of Agent Skills, read the engineering blog: [Equipping agents for the real world with Agent Skills](https://www.anthropic.com/news/agent-skills).
...
* **Use Skills in Claude Code**: Create and manage custom Skills in Claude Code
